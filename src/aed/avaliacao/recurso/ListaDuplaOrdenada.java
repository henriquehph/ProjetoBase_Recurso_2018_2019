...
public class ListaDuplaOrdenada<T> implements ColecaoIteravelLinearOrdenada<T> {
    ...
    public ListaDuplaOrdenada<T> removerTodos(T elem) {
        ListaDuplaOrdenada<T> rem = new ListaDuplaOrdenada<>(criterio);
        ...
        ultimo = ultimo.anterior; //ultimo e o removido, ajusta ponteiros pra remover,
        primeiro.anterior.seguinte = ultimo.seguinte;
        ultimo.seguinte.anterior = primeiro.anterior;//liga no anterior ao primeiro e o proximo ao ultimo
        rem.base.seguinte = primeiro;
        primeiro.anterior = rem.base;
        ultimo.seguinte = rem.base;
        rem.base.anterior = ultimo; // adiciona os nos a lista removidos,
